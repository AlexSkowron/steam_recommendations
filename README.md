...
2. Implementing and testing collaborative-filtering (CF) recommender systems that rely on implicit user interactions (mainly game purchases and playtime). This sub-project is the most developed and the code is documented in the jupyter notebook CF_steam_recommender.ipynb. For now, this sub-project uses the [steam 200k dataset](https://www.kaggle.com/datasets/tamber/steam-video-games) from kaggle for training and testing.
